  ...
  return (
    <div className="ml-10 mt-10 flex w-[50%] flex-col">
      ...
      {musicTheories.map((theory) => (
        <div className="mr-5 mt-5 flex cursor-pointer items-center justify-between rounded-3xl border bg-gray-200 hover:bg-gray-900 hover:text-white">
          <div className="flex w-full items-center justify-between p-5">
            <div className="" key={theory.icon}>
              <img
                src={theory.icon}
                alt="random"
